...
public class titems extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        row= inflater.inflate(R.layout.titems,container,false);
        return row;
    }
    ...
    AbsListView.MultiChoiceModeListener modeListener=new AbsListView.MultiChoiceModeListener() {
        ...
        public void onItemCheckedStateChanged(ActionMode mode, int position, long id, boolean checked) {
            if(userSelection.contains(constants.itemId.get(position))){
                userSelection.remove(constants.itemId.get(position));
            }else{
                userSelection.add(constants.itemId.get(position));
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            int count=constants.itemId.size();
            for(int i=0;i<count;i++){
