...
public class tshipment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        row = inflater.inflate(R.layout.tshipment,container,false);
        return row;
    }
    ...
    AbsListView.MultiChoiceModeListener modeListener=new AbsListView.MultiChoiceModeListener() {
        ...
        public void onItemCheckedStateChanged(ActionMode mode, int position, long id, boolean checked) {
            if(userSelection.contains(constants.shipid.get(position))){
                userSelection.remove(constants.shipid.get(position));
            }else{
                userSelection.add(constants.shipid.get(position));
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            int count=constants.shipid.size();
            for(int i=0;i<count;i++){
